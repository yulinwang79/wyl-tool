 ...
 //           dgvPortConfig.CurrentRow.Cells[1].Value = cbCfgValue.Text;
        ...
        private void dgvPortConfig_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (defaultValue != null)
            {
                ...
                string[] item_sel = defaultValue.Trim().Split(stringSeparators, StringSplitOptions.RemoveEmptyEntries);
            ...
            /*
            if (defaultValue !=null && (m_portConfig.m_type == Config.EditType.EDIT_PORT_CONFIG
