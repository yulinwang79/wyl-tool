...
int _login(void)
{
  ...
  do {
    ...
    r= MMM_WaitEvent(WAITEVENT_TIME,(t_lable_info*)&s_logon_lable[0],countof(s_logon_lable),NULL);
    ...
    case ID_LOGON_PASSWORD:
        r = _VVEditNum("Password",s_password,PASSWORD_MAX_LENTH);
        break;
    case ID_LOGON_NEWPASSWORD:
        r = _VVEditNum("New Password",s_new_password,PASSWORD_MAX_LENTH);
        break;
	case WAIT_EVENT_TIMEOUT:
		break;
    }
  }while((r != 0) && (r != WAIT_EVENT_TIMEOUT));
  return r;
}
