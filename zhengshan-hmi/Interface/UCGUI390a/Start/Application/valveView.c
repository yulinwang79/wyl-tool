...
#include ".\reource\valveView\vv_logout_pressed.c"
#include ".\reource\valveView\vv_logout_unpressed.c"
...
static const t_button_info s_vv_button[]={
    ...
    {ID_VV_LOGOUT,&bmvv_logout_pressed,&bmvv_logout_unpressed,&bmvv_logout_pressed,{153 ,200, 219,236},NULL,hmi_is_logout},
    {ID_VV_LOGON,&bmvv_logon_pressed,&bmvv_logon_unpressed,&bmvv_logon_pressed,{153 ,200, 219,236},NULL,hmi_is_login},
